...
return [
    ...
    'drivers' => [
        ...
        'persistent' => new Config\SQLiteDriverConfig(
            connection: new Config\SQLite\FileConnectionConfig(directory('root') . 'app.db'),
            queryCache: true
        ),
        'mariadb' => new Config\MySQLDriverConfig(
            connection: new Config\MySQL\DsnConnectionConfig(
                dsn: 'mysql:host=mariadb;dbname=arena',
                user: 'arena-user',
